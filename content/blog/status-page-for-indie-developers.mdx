...
Trade-off: you depend on the host. But for an indie product, that's fine — you depend on Vercel, Cloudflare, Supabase, and Stripe already. One more dependency at $0 isn't the bottleneck.
...
A monitoring service (your status page tool, or a separate uptime checker) pings each of your service URLs on a schedule — typically every 1–5 minutes — and flips the status based on what it sees:
