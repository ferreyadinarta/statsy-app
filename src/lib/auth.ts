...
export async function getUserFromHeaders(): Promise<{ id: string; email: string | null } | null> {
...
export function getUserFromRequest(request: NextRequest): { id: string; email: string | null } | null {
